...
from vlaa_gui.agents.coding_agent import CodeAgent
from vlaa_gui.agents.search_agent import SearcherAgent
        ...
        **🚨 CRITICAL GUIDELINES:**
        ...
        if task is not None:
            ...
            if self.current_task_instruction:
                from vlaa_gui.agents.coding_agent import extract_constraints
